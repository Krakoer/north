    ...
    with open("output.s", "w") as out:
        ...
        for ip, op in enumerate(prg):
            ...
            if op["type"] == Ops.PUSH:
                ...
                out.write(f"\t ; -- PLUS -- (n1 n2 -- n1+n2)\n")
                out.write("\tjsr PLUS\n")

            elif op["type"] == Ops.MINUS:
                out.write("\t ; -- MINUS -- (n1 n2 -- n1-n2)\n")
                out.write("\tjsr MINUS\n")
                ...
                out.write("\t ; -- EQUAL -- (n1 n2 -- f) f = 0 if n1==n2 and ffff otherwise\n")
                out.write("\tjsr EQ\n")
            ...
            elif op["type"] == Ops.LOAD:
                out.write("\t ; -- LOAD -- \n")
                out.write("\tjsr FETCH\n")

            elif op["type"] == Ops.STORE:
                out.write("\t ; -- STORE -- \n")
                out.write("\tjsr STORE\n")
